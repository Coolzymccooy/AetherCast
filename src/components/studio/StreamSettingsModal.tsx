...
const PRESETS = [
  ...
  { name: 'Twitch (RTMPS)', url: 'rtmps://ingest.global-contribute.live-video.net:443/app', icon: '🟣', color: 'text-purple-500' },
  { name: 'Twitch (RTMP)', url: 'rtmp://ingest.global-contribute.live-video.net/app', icon: '🟣', color: 'text-purple-400' },
